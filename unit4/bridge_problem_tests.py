...
>>> bridge_problem([12,24])
[(frozenset([24, 'light', 12]), frozenset([]), 0), (12, 24, '->'), (frozenset([]), frozenset([24, 'light', 12]), 24)]

>>> bridge_problem([12,24,35])
[(frozenset([24, 'light', 35, 12]), frozenset([]), 0), (12, 24, '->'), (frozenset([35]), frozenset([24, 'light', 12]), 24), (12, 12, '<-'), (frozenset(['light', 35, 12]), frozenset([24]), 36), (12, 35, '->'), (frozenset([]), frozenset([24, 'light', 35, 12]), 71)]
